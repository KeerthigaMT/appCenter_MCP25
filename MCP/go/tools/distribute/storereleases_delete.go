...
func Storereleases_deleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateStorereleases_deleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_v0_1_apps_owner_name_app_name_distribution_stores_store_name_releases_release_id",
		mcp.WithDescription("delete the release with release Id"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Storereleases_deleteHandler(cfg),
	}
}
