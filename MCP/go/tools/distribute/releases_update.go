...
func Releases_updateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReleases_updateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_v0_1_apps_owner_name_app_name_releases_release_id",
		mcp.WithDescription("Updates a release."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Releases_updateHandler(cfg),
	}
}
