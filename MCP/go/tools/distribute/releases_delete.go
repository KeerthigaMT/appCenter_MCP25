...
func Releases_deleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReleases_deleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_v0_1_apps_owner_name_app_name_releases_release_id",
		mcp.WithDescription("Deletes a release."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Releases_deleteHandler(cfg),
	}
}
