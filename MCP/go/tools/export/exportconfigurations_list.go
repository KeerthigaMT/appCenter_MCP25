...
func Exportconfigurations_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateExportconfigurations_listTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_apps_owner_name_app_name_export_configurations",
		mcp.WithDescription("List export configurations."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Exportconfigurations_listHandler(cfg),
	}
}
