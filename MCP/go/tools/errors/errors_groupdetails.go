...
func Errors_groupdetailsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateErrors_groupdetailsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_apps_owner_name_app_name_errors_errorGroups_errorGroupId",
		mcp.WithDescription("Error group details"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Errors_groupdetailsHandler(cfg),
	}
}
