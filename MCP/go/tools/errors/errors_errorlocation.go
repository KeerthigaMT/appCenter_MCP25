...
func Errors_errorlocationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v0.1/apps/%s/%s/errors/errorGroups/%s/errors/%s/location", cfg.BaseURL, errorGroupId, errorId, owner_name, app_name)
...
func CreateErrors_errorlocationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_apps_owner_name_app_name_errors_errorGroups_errorGroupId_errors_errorId_location",
		mcp.WithDescription("Error location."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Errors_errorlocationHandler(cfg),
	}
}
