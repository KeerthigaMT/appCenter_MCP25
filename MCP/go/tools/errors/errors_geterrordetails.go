...
func Errors_geterrordetailsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateErrors_geterrordetailsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_apps_owner_name_app_name_errors_errorGroups_errorGroupId_errors_errorId",
		mcp.WithDescription("Error details."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Errors_geterrordetailsHandler(cfg),
	}
}
