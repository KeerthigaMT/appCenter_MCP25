...
func Analytics_listcustompropertiesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v0.1/apps/%s/%s/analytics/audiences/metadata/custom_properties", cfg.BaseURL, owner_name, app_name)
...
func CreateAnalytics_listcustompropertiesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_apps_owner_name_app_name_analytics_audiences_metadata_custom_properties",
		mcp.WithDescription("Get list of custom properties."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Analytics_listcustompropertiesHandler(cfg),
	}
}
