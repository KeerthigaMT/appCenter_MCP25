...
func Crashgroups_getHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCrashgroups_getTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_apps_owner_name_app_name_crash_groups_crash_group_id",
		mcp.WithDescription("Gets a specific group."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Crashgroups_getHandler(cfg),
	}
}
