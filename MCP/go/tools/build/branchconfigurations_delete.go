...
func Branchconfigurations_deleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateBranchconfigurations_deleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_v0_1_apps_owner_name_app_name_branches_branch_config",
		mcp.WithDescription("Deletes the branch build configuration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Branchconfigurations_deleteHandler(cfg),
	}
}
