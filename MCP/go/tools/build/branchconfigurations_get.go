...
func Branchconfigurations_getHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateBranchconfigurations_getTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_apps_owner_name_app_name_branches_branch_config",
		mcp.WithDescription("Gets the branch configuration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Branchconfigurations_getHandler(cfg),
	}
}
