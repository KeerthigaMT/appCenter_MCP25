...
func Repositoryconfigurations_deleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepositoryconfigurations_deleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_v0_1_apps_owner_name_app_name_repo_config",
		mcp.WithDescription("Removes the configuration for the repository"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repositoryconfigurations_deleteHandler(cfg),
	}
}
