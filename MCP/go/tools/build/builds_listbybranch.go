...
func Builds_listbybranchHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateBuilds_listbybranchTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_apps_owner_name_app_name_branches_branch_builds",
		mcp.WithDescription("Returns the list of builds for the branch"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Builds_listbybranchHandler(cfg),
	}
}
