...
func Distributiongroups_listusersfororgHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDistributiongroups_listusersfororgTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_orgs_org_name_distribution_groups_distribution_group_name_members",
		mcp.WithDescription("Returns a list of member in the distribution group specified"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Distributiongroups_listusersfororgHandler(cfg),
	}
}
