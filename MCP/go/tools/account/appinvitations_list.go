...
func Appinvitations_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateAppinvitations_listTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_apps_owner_name_app_name_invitations",
		mcp.WithDescription("Gets the pending invitations for the app"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Appinvitations_listHandler(cfg),
	}
}
