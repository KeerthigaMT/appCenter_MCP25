...
func Appapitokens_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateAppapitokens_listTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_apps_owner_name_app_name_api_tokens",
		mcp.WithDescription("Returns App API tokens for the app"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Appapitokens_listHandler(cfg),
	}
}
