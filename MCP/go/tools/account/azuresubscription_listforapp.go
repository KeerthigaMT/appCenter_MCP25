...
func Azuresubscription_listforappHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateAzuresubscription_listforappTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_apps_owner_name_app_name_azure_subscriptions",
		mcp.WithDescription("Returns a list of azure subscriptions for the app"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Azuresubscription_listforappHandler(cfg),
	}
}
