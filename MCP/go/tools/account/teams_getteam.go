...
func Teams_getteamHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateTeams_getteamTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_orgs_org_name_teams_team_name",
		mcp.WithDescription("Returns the details of a single team"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Teams_getteamHandler(cfg),
	}
}
