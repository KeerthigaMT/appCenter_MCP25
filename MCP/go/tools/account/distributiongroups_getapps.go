...
func Distributiongroups_getappsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDistributiongroups_getappsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_orgs_org_name_distribution_groups_distribution_group_name_apps",
		mcp.WithDescription("Get apps from a distribution group in an org"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Distributiongroups_getappsHandler(cfg),
	}
}
