...
func Teams_listappsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateTeams_listappsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_orgs_org_name_teams_team_name_apps",
		mcp.WithDescription("Returns the apps a team has access to"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Teams_listappsHandler(cfg),
	}
}
