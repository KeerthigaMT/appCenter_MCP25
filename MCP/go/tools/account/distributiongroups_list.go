...
func Distributiongroups_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDistributiongroups_listTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_apps_owner_name_app_name_distribution_groups",
		mcp.WithDescription("Returns a list of distribution groups in the app specified"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Distributiongroups_listHandler(cfg),
	}
}
