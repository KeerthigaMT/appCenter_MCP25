...
func Test_uploadhashesbatchHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v0.1/apps/%s/%s/test_runs/%s/hashes/batch", cfg.BaseURL, test_run_id, owner_name, app_name)
...
func CreateTest_uploadhashesbatchTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v0_1_apps_owner_name_app_name_test_runs_test_run_id_hashes_batch",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Test_uploadhashesbatchHandler(cfg),
	}
}
