...
func Test_listdevicesetsofuserHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateTest_listdevicesetsofuserTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_apps_owner_name_app_name_user_device_sets",
		mcp.WithDescription("Lists device sets belonging to the user"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Test_listdevicesetsofuserHandler(cfg),
	}
}
