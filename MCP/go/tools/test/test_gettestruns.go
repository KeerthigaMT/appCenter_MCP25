...
func Test_gettestrunsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateTest_gettestrunsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_apps_owner_name_app_name_test_runs",
		mcp.WithDescription("Returns a list of test runs"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Test_gettestrunsHandler(cfg),
	}
}
