...
func Test_createdevicesetofownerHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateTest_createdevicesetofownerTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v0_1_apps_owner_name_app_name_owner_device_sets",
		mcp.WithDescription("Creates a device set belonging to the owner"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Test_createdevicesetofownerHandler(cfg),
	}
}
