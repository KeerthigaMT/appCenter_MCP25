...
func Test_createsubscriptionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateTest_createsubscriptionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v0_1_apps_owner_name_app_name_subscriptions",
		mcp.WithDescription("Accept a free trial subscription"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Test_createsubscriptionHandler(cfg),
	}
}
