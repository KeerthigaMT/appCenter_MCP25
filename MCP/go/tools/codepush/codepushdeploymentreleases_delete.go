...
func Codepushdeploymentreleases_deleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCodepushdeploymentreleases_deleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_v0_1_apps_owner_name_app_name_deployments_deployment_name_releases",
		mcp.WithDescription("Clears a Deployment of releases"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Codepushdeploymentreleases_deleteHandler(cfg),
	}
}
