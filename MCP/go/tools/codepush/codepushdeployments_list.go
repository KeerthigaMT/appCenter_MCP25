...
func Codepushdeployments_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCodepushdeployments_listTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_apps_owner_name_app_name_deployments",
		mcp.WithDescription("Gets a list of CodePush deployments for the given app"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Codepushdeployments_listHandler(cfg),
	}
}
