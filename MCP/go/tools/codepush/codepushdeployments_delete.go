...
func Codepushdeployments_deleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCodepushdeployments_deleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_v0_1_apps_owner_name_app_name_deployments_deployment_name",
		mcp.WithDescription("Deletes a CodePush Deployment for the given app"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Codepushdeployments_deleteHandler(cfg),
	}
}
