...
func Codepushdeployments_getHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCodepushdeployments_getTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v0_1_apps_owner_name_app_name_deployments_deployment_name",
		mcp.WithDescription("Gets a CodePush Deployment for the given app"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Codepushdeployments_getHandler(cfg),
	}
}
